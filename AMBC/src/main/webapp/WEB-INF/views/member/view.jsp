...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <main class="main-content position-relative border-radius-lg ">
    ...
    <!-- End Navbar -->
    <div class="pagetitle">
      <h3 style="color: white;">회원정보 상세보기</h3>
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit">회원수정</button>
                </li>

                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-settings">회원탈퇴</button>
                </li>
                </c:if>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
		              ...
		              <img src="./resources/profile/${view.MProfileName}" alt="Profile" class="rounded-circle">
        		     	 <h2>${view.MName}</h2>
				  ...
				  <c:if test="${loginId eq view.MId || loginId eq 'admin'}">
  					<div class="row">
    					...
    					<div class="col-lg-9 col-md-8">${view.MPw}</div>
  					</div>
				  </c:if>
                  ...
                  <form action="mModify" method="post" enctype="multipart/form-data">
								...
								<div class="row mb-3">
									...
									<div class="col-sm-10">
										...
										<br/><img src="./resources/profile/${view.MProfileName}" id="preview" width="150px" />
									</div>
								</div>
